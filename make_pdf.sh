...
jupyter nbconvert --to=pdf --template=./templates/article.tplx --output-dir=./pdf/ 40_tensorflow/42_Keras.ipynb
jupyter nbconvert --to=pdf --template=./templates/article.tplx --output-dir=./pdf/ 40_tensorflow/43_MNIST.ipynb
